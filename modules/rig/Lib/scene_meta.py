...
STEP_ORDER = [
    ...
    ("leg_L", "Body Setup (legs L)"),
    ("leg_R", "Body Setup (legs R)"),
    ("foot_L", "Body Setup (foot L)"),
    ("foot_R", "Body Setup (foot R)"),
    ("arm_L", "Body Setup (arms L)"),
    ("arm_R", "Body Setup (arms R)"),
    ("torso", "Body Setup (torso)"),
...
STEP_TOOLS = {
    ...
    "leg_L": ("Workflow", "body_setup",
              {"sides": "L", "arm_build": "none", "torso_build": "none"}),
    "leg_R": ("Workflow", "body_setup",
              {"sides": "R", "arm_build": "none", "torso_build": "none"}),
    "arm_L": ("Workflow", "body_setup",
              {"sides": "L", "leg_build": "none", "torso_build": "none"}),
    "arm_R": ("Workflow", "body_setup",
              {"sides": "R", "leg_build": "none", "torso_build": "none"}),
    "foot_L": ("Workflow", "body_setup",
               {"sides": "L", "arm_build": "none", "leg_build": "none",
                "torso_build": "none", "foot_build": "reverse"}),
    "foot_R": ("Workflow", "body_setup",
               {"sides": "R", "arm_build": "none", "leg_build": "none",
                "torso_build": "none", "foot_build": "reverse"}),
    "torso": ("Workflow", "body_setup",
              {"arm_build": "none", "leg_build": "none", "torso_build": "fk"}),
